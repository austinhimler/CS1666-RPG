...
void TextRenderer::Initialize(int screenWidth, int screenHeight)
{
	...
	auto shader = ResourceManager::loadShader("Shaders/textShader.vs", "Shaders/textShader.frag", nullptr, "text_shader");
	...
	GLuint vText = glGetAttribLocation(ResourceManager::getShader("text_shader").Program, "vText");
...
void TextRenderer::RenderText(RenderableText renderText)
{
	...
	auto shader = ResourceManager::getShader("text_shader");
